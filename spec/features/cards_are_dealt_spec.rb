...
feature 'User sees how the cards were dealt' do
  scenario 'Two players were entered and they see their hands' do
    ...
    srand(100)
    click_button 'Submit'
    expect(page).to have_content("Outcome\n(The card values are Jack = 11,"\
                                 ' Queen = 12, King = 13) Player number 1 :'\
                                 ' King of Hearts || Queen of Clubs || Player'\
                                 ' number 2 : 10 of Clubs || Queen of Spades ||'\
                                 ' Player number 3 : 10 of Spades || King'\
                                 ' of Diamonds || And the winner is: Player'\
                                 ' number 1')
